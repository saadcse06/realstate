            ...
            @if(\Illuminate\Support\Facades\Auth::user()->can('group.menu'))
                <li class="nav-item">
                    ...
                    <div class="collapse" id="advancedUI">
                        <ul class="nav sub-menu">
                            @if(\Illuminate\Support\Facades\Auth::user()->can('group.list'))
                                <li class="nav-item">
                                    <a href="{{ route('group.list') }}" class="nav-link">Group List</a>
                                </li>
                            @endif
                            @if(\Illuminate\Support\Facades\Auth::user()->can('group.create'))
                                <li class="nav-item">
                                    <a href="{{ route('group.create') }}" class="nav-link">Add Group</a>
                                </li>
                            @endif
                        </ul>
                    </div>
            ...
            @if(\Illuminate\Support\Facades\Auth::user()->can('permission.menu'))
                <li class="nav-item">
                    ...
                    <div class="collapse" id="permissions">
                        <ul class="nav sub-menu">
                            @if(\Illuminate\Support\Facades\Auth::user()->can('permission.list'))
                                <li class="nav-item">
                                    <a href="{{ route('permission.list') }}" class="nav-link">All Permission</a>
                                </li>
                            @endif
                            @if(\Illuminate\Support\Facades\Auth::user()->can('permission.add'))
                                <li class="nav-item">
            ...
            @if(\Illuminate\Support\Facades\Auth::user()->can('role.menu'))
                <li class="nav-item">
                    ...
                    <div class="collapse" id="roles">
                        <ul class="nav sub-menu">
                            @if(\Illuminate\Support\Facades\Auth::user()->can('role.list'))
                                <li class="nav-item">
                                    <a href="{{ route('role.list') }}" class="nav-link">All Role</a>
                                </li>
                            @endif
                            @if(\Illuminate\Support\Facades\Auth::user()->can('role.add'))
                                <li class="nav-item">
            ...
            @if(\Illuminate\Support\Facades\Auth::user()->can('admin.menu'))
                <li class="nav-item">
                    ...
                    <div class="collapse" id="admins">
                        <ul class="nav sub-menu">
                            @if(\Illuminate\Support\Facades\Auth::user()->can('admin.list'))
                                <li class="nav-item">
                                    <a href="{{ route('admin.list') }}" class="nav-link">All Admin User</a>
                                </li>
                            @endif
                            @if(\Illuminate\Support\Facades\Auth::user()->can('admin.add'))
                                <li class="nav-item">
